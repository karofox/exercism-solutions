...
class Hand:
    ...
    @property
    def amounts_of_values(self) -> collections.defaultdict[int, list[int]]:
        """Returns the defaultdict of amounts of card values in hand.
        
        Each key-value pair represents an amount of cards of the same card value (key) 
        and number of values for which such combination exists in hand (values),
        
        E. g. for the hand of 4S 5H 4C 5D 4H:
        key | value
        -----------
        3   | 1     <- we have one collection of three cards of the same value, three "4" cards. 
        2   | 1     <- we have one collection of two cards of the same value, two "5" cards.

        E. g. for the hand of 6S 6H 3S 3H AS:
        key | value
        -----------
        2   | 2     <- we have two collections of two cards of the same value, two "6" cards and two "3" cards. 
        1   | 1     <- we have one card with value that does not repeat, one "A" card.     
        """
