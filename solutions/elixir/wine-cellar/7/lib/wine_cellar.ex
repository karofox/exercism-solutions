defmodule WineCellar do
  ...
  def filter(cellar, color, opts \\ []),
    do:
      ...
      |> filter_optionally(opts[:year], &filter_by_year/2)
      |> filter_optionally(opts[:country], &filter_by_country/2)

  @spec filter_optionally([wine()], any(), ([wine()], any() -> [wine()])) :: [wine()]
  defp filter_optionally(wines, nil, _filter_function), do: wines
  defp filter_optionally(wines, value, filter_function), do: filter_function.(wines, value)
